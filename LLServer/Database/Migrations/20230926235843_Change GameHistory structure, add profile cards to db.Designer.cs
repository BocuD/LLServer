...
namespace LLServer.Database.Migrations
{
    ...
    [Migration("20230926235843_Change GameHistory structure, add profile cards to db")]
    partial class ChangeGameHistorystructureaddprofilecardstodb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LLServer.Models.UserData.GameHistoryAqours", b =>
                {
                    b.Property<string>("DbId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("GameHistoryAqours");
                });

            modelBuilder.Entity("LLServer.Models.UserData.GameHistorySaintSnow", b =>
                {
                    b.Property<string>("DbId")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("GameHistorySaintSnow");
                });
            ...
            modelBuilder.Entity("LLServer.Database.Models.User", b =>
                {
                    ...
                    b.Navigation("GameHistoryAqours");

                    b.Navigation("GameHistorySaintSnow");
