...
namespace LLServer.Database.Migrations
{
    ...
    [Migration("20231001024818_Add MailBox to db")]
    partial class AddMailBoxtodb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LLServer.Models.Travel.TravelData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LLServer.Models.Travel.TravelHistory", b =>
                {
                    b.Property<int>("DbId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LLServer.Models.Travel.TravelPamphlet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("LLServer.Models.Travel.TravelTalk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("MyCharacterId")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "my_character_id");
                    ...
                    b.Property<int>("TalkId")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "talk_id");
            ...
            modelBuilder.Entity("LLServer.Models.UserData.LimitedAchievement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("LimitedAchievementId")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "m_limited_achievement_id");
                    ...
                    b.ToTable("LimitedAchievements");
                });

            modelBuilder.Entity("LLServer.Models.UserData.MailBoxItem", b =>
                {
                    b.Property<int>("DbId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("Attrib")
                        .HasColumnType("INTEGER")
                        .HasAnnotation("Relational:JsonPropertyName", "attrib");
            ...
            modelBuilder.Entity("LLServer.Database.Models.User", b =>
                {
                    ...
                    b.Navigation("LimitedAchievements");
