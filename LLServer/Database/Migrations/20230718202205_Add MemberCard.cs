...
{
    /// <inheritdoc />
    public partial class AddMemberCard : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MemberCardData", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MemberCardData_Users_UserID",
                        column: x => x.UserID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MemberCardData_UserID",
                table: "MemberCardData",
                column: "UserID");
        }
