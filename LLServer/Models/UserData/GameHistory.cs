...
public class GameHistory
{
    ...
    [JsonPropertyName("id"), NotMapped] public string Id => DbId.ToString();

    [JsonPropertyName("play_place")] public string PlayPlace { get; set; } = "";

    [JsonPropertyName("created")] //standard datetime used in other places (e.g. playdate or now)
    public string Created { get; set; } = "";

    [JsonPropertyName("d_user_id")] public string DUserId { get; set; } = "";
    ...
    [JsonPropertyName("skill_cards_main")] public int[] SkillCardsMain { get; set; } = Array.Empty<int>();
    ...
    [JsonPropertyName("skill_arg_camera")] public int[] SkillArgCamera { get; set; } = Array.Empty<int>();
    ...
    [JsonPropertyName("print_rest")] public int PrintRest { get; set; } = 1;
