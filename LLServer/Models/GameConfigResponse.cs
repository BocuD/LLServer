...
public class GameConfigResponse : ResponseBase
{
    ...
    [JsonPropertyName("music_release_version")] public int MusicReleaseVersion { get; set; } = 1;
    [JsonPropertyName("finale_focus_release_version")] public int FinaleFocusReleaseVersion { get; set; } = 1;
    [JsonPropertyName("stage_release_version")] public int StageReleaseVersion { get; set; } = 1;
    [JsonPropertyName("member_card_release_version")] public int MemberCardReleaseVersion { get; set; } = 1;
    [JsonPropertyName("memorial_card_release_version")] public int MemorialCardReleaseVersion { get; set; } = 1;
    [JsonPropertyName("skill_card_release_version")] public int SkillCardReleaseVersion { get; set; } = 1;
